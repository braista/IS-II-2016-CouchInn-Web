<html>
    <head>
        ...
        <?php
            ...
            $link=  connect();            
        ?>                
        <title>CouchInn - Calificar usuario</title>
    </head>
    <body>
		<!-- HEADER -->
		...
		<div id="contenedor">
            <div id="content"> 
				...
				<div id="info">
                    <div id="title">
                        <p>Calificar huesped</p>
                    </div>    
                    <p style="width: 100%; text-indent: 1%;overflow: hidden;">Califica al huesped con un numero entre 1 y 5, incluyendo un comentario obligatorio.</p>
                    <?php
                        if(count($_POST)!=0){
                    ...
                    <div id="registerSection">
                        <form name="rateUser" method="POST" action="addUserRate.php" onsubmit="return formValidation('rate')">
                            <div id="formItem">
                                <div class="formLabel">
