...
if(count($_POST) != 0){
    ...
    $query= "INSERT INTO reservas (fecha_inicio, fecha_fin, cantidad, idcouch, idusuario, idestado) "
            . "VALUES('$fdate', '$tdate', '$amount', '$couchID', '$userID', '1')";
    ...
    if($result){
        ...
        alert("Hubo un problema con el procesamiento en la base de datos.");
        back();
    }
}else{
