<html>
    <head> 
        ...
        $link=  connect();        
        ?>  
        <title>CouchInn - Puntuación del couch</title>
	</head>
		<body>
			<!-- HEADER -->
			<header>		
	       ...
	       <!-- CONTENEDOR-->
			<div id="contenedor">
                <div id="content">
                    ...
                    <div id="info">
                        <div id="title">
                            <p class="noMargin">Puntuación del couch</p>
                        </div>
                        <p style="width: 100%; overflow: hidden;">Todas las puntuaciones del couch con sus respectivos comentarios.</p>
                        <?php
                        if(count($_GET)!=0){
                            $couchID= $_GET['id'];
                            $query= "SELECT * FROM `puntajes-couchs` WHERE idcouch=$couchID";
